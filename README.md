...
## ქართული გრამატიკის Skill Codex-ისთვის

ეს სკილი ეხმარება აგენტს გამართული, ბუნებრივი და ნორმების შესაბამისი ქართული ტექსტის წერაში, რედაქტირებაში, თარგმნაში, პუნქტუაციის შემოწმებასა და გრამატიკულ ანალიზში.
